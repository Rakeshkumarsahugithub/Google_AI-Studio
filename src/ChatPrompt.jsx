...
export default function Chat() {
  ...
  return (
    <div className="min-h-screen bg-[#1e1e1e] text-white p-4 md:p-8 rounded-[2rem] md:mr-16 mr-1">
      {/* Top Bar */}
      <div className="flex justify-between items-center mb-4">
        <h1 className="text-sm md:text-base font-medium">Chat Prompt</h1>
        <div className="flex space-x-1 md:space-x-2">
          {icons.map((item, idx) => (
            ...
            >
              <div className="text-gray-400">{item.icon}</div>
              {hoveredIcon === idx && (
                <div className="absolute top-full left-1/2 transform -translate-x-1/2 mt-1 px-2 py-1 bg-gray-800 text-white text-xs rounded whitespace-nowrap z-10 max-w-[180px] text-center">
                  {item.tooltip}
                </div>
              )}
            </div>
      ...
      <div className="flex flex-col items-center justify-center min-h-[calc(100vh-200px)]">
        <h2 className="text-2xl md:text-4xl font-semibold text-center bg-clip-text text-transparent bg-gradient-to-r from-blue-100 via-blue-500 to-blue-900 mb-6 md:mb-10">
          Welcome to AI Studio
        </h2>

        {/* Prompt Box */}
        <div className="flex items-center bg-[#2a2a2a] rounded-full px-3 md:px-4 py-2 md:py-3 mb-6 md:mb-8 w-full max-w-2xl relative">
          <input
            value={prompt}
            onChange={handleInputChange}
            placeholder={sentences[index]}
          ...
          <div className="relative group mr-1 md:mr-2">
            ...
            />
            <div className="absolute bottom-full mb-1 left-1/2 transform -translate-x-1/2 bg-gray-800 text-white text-[10px] md:text-xs rounded px-2 py-1 opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap z-10">
          ...
          {/* Run Button */}
          <div className="relative group">
            <button className="flex items-center gap-1 bg-[#3c3c3c] hover:bg-[#505050] text-xs md:text-sm px-3 md:px-4 py-1 rounded-full text-gray-300">
