...
-d '{
  ...
  return (
    <div className="bg-[#1a1a1a] min-h-screen text-white p-6 relative">
      <div className="max-w-6xl mx-auto pl-[3rem]">

        {/* Header */}
        <div className="flex justify-between items-center mb-6">
          <h1 className="text-2xl font-semibold">API Keys</h1>
          <button className="flex items-center gap-2 cursor-pointer bg-[#7a9fe3] hover:bg-[#688fd0] border border-[#3c4043] text-[#1e3a8a] font-semibold px-4 py-2 rounded-3xl mr-[5rem]">
        ...
        <div className="flex justify-between items-start">
          <div className="w-full max-w-3xl cursor-pointer">
            ...
            {/* Code Box */}
            <div className="mt-4 bg-[#1e1f20] rounded-lg w-full sm:w-[400px] lg:w-[950px] overflow-hidden font-mono text-sm text-blue-400">
              <pre className="whitespace-pre-wrap leading-relaxed p-6">
                <code>
                  <span className="text-white">curl</span> "https://generativelanguage.googleapis.com/vibeta/models/gemini-2.0-flash:generateContent?key=GEMINI_API_KEY" \<br />
              ...
              {/* Actions */}
              <div className="w-full flex items-center justify-between px-6 py-3 bg-[#4B4B4B] border-t border-[#2a2a2a] rounded-b-lg relative">
            ...
            {/* Table */}
            <div className="mt-6 w-full sm:w-[400px] lg:w-[950px] border border-[#2a2a2a] rounded-lg overflow-hidden">
